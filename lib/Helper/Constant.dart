...
class APIS {
  static var baseurl = "https://dietaholics.com/owners_service/";

  //LOGIN
  static var login = baseurl + "login";
  //Restaurants LIST
  static var resList = baseurl + "restaurant_list";
  //Restaurnat Details
  ...
  //Add Restaurant
  static var addRestaurant = baseurl + 'addUpdateRestaurant';
  //Update Restaurant
  static var updateRestaurant = baseurl + 'addUpdateRestaurant/';
  //Add Product
  ...
  //Close Restaurant
  static var closeRestaurant = baseurl + 'change_restaurant_availability';
  //OutofStock Item
  static var outofStockItem = baseurl + 'change_product_availability';
  //Delete Product
  static var deleteProduct = baseurl + 'delete_product/';
  //Delete Retaurant
  static var deleteRestaurant = baseurl + 'delete_restaurant/';
  //Restaurat Review
...
class AppColor {
  static var themeColor = hexToColor('#000000');
...
class AppImages {
  ...
  static var appLogo = AssetImage('Assets/AppLogo/owner.jpg');
