...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
          ...
          builder: (context, AsyncSnapshot<ResOrderDetails> snapshot) {
            if (snapshot.hasData) {
              ...
              return Container(
                ...
                child: ListView(
                  children: <Widget>[
                    _setCustomerDetails(result.name, 'test@gmail.com',
                        result.phone, result.deliveryAddress),
                    _setOrderDetails(
                        result.orderId,
                        result.orderStatus,
                        result.paymentType,
  ...
  _setCustomerDetails(String name, String email, String phone, String address) {
    return Container(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          setWithSpace(5),
                                          setCommonText(
                                              '${Currency.curr}${productList[index].price}',
                                              AppColor.grey[600],
                                              12.0,
                                              FontWeight.w500,
                                              1,
  ...
  _setOrderDetails(String orderId, String status, String paymentType,
      String tip, String discount, String price) {
    return Container(
      // height: 300,
      padding: new EdgeInsets.all(12),
      child: Material(
            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  setHeightSpace(5),
                  _setCommonView('${S.current.paymentStatus} :', 'Received'),
                  setHeightSpace(5),
