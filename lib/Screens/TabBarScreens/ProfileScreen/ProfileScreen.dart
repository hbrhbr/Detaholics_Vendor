...
_setOrderStatusView(BuildContext context) {
  return Container(
    height: 71,
    color: AppColor.white,
    child: Column(
        ...
        Row(
          children: <Widget>[
            Expanded(
              ...
              height: 70,
              // color: AppColor.red,
              child: _setCommonView(context, '${S.current.total_order}', "120"),
            )),
            Container(
            ...
            Expanded(
                child: Container(
              height: 70,
              child: _setCommonView(context, '${S.current.todays_order}', "10"),
            ...
            Expanded(
              ...
              child: _setCommonView(context, '${S.current.new_order}', "4"),
            )),
          ],
        ),
        Container(
