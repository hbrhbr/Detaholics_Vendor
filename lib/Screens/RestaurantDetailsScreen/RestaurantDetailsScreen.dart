...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen> {
  ...
  _closeRestaurant(String resId, String status) async {
    final param = {"is_available": "$status", "restaurant_id": "$resId"};
  ...
  _setCategory(List<Subcategories> subcategories, BuildContext context) {
    return Container(
      height: (subcategories.length * 125).toDouble(),
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    Expanded(
                                      child: setCommonText(
                                          (subcategories[index].isAvailable ==
                                                  '1')
                                              ? '${S.current.available}'
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Switch(
                                value: (subcategories[index].isAvailable == '1')
                                    ? true
                                    : false,
                                onChanged: (value) {
                                  _makeOutofStock(
                                      subcategories[index].id,
                                      (subcategories[index].isAvailable == '1')
                                          ? '0'
                                          : '1');
                                  setState(() {
                                    if (subcategories[index].isAvailable ==
                                        '1') {
                                      subcategories[index].isAvailable = '0';
                                    } else {
                                      subcategories[index].isAvailable = '1';
                                    }
                                  });
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      onTap: () {
                        Share.share(
                          '${this.result.name} , ${this.result.address}',
                        );
                      },
                      child:
                          _setCommonColumn(S.current.share, Icon(Icons.share)),
                    )),
                  ),
                  Expanded(
                      flex: 2,
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              setCommonText('Opening time:', AppColor.black87,
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              setCommonText('Closing time:', AppColor.black87,
                                  14.0, FontWeight.w500, 1, TextAlign.start),
                              SizedBox(height: 3),
                              Expanded(
                                  child: Container(
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              setCommonText('Average cost:', AppColor.black87,
                                  14.0, FontWeight.w500, 1, TextAlign.start),
                              SizedBox(height: 3),
                              Expanded(
                                  child: Container(
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              setCommonText('Discount:', AppColor.black87, 14.0,
                                  FontWeight.w500, 1, TextAlign.start),
                              SizedBox(height: 3),
                              Expanded(
                                  child: Container(
